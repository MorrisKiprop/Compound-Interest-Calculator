...
class AnnualCompoundmentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_annual_compoundment)
        ...
        CALCULATEBUTTON.setOnClickListener {
            ...
            try {
                ...
                MYRESULT.text="The total amount accrued on a principal of $firstNumber at a rate of $secondNumber% per year compounded once per year over $thirdNumber years  is $COMPOUNDINTEREST."

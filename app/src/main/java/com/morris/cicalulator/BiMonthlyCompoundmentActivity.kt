...
class BiMonthlyCompoundmentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bi_monthly_compoundment)
        ...
        CALCULATEBUTTON.setOnClickListener {
            ...
            try {
                ...
                fun accountafterinterest() = firstNumber * (1 + secondNumber / 600) .pow(6*thirdNumber)
                var COMPOUNDINTEREST=accountafterinterest()


                MYRESULT.text="The total amount accrued on a principal of $firstNumber at a rate of $secondNumber% per year compounded 6 times per year over $thirdNumber years  is $COMPOUNDINTEREST."

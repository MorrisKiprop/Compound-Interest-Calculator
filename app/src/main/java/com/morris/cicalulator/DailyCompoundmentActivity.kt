...
class DailyCompoundmentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_daily_compoundment)
        ...
        CALCULATEBUTTON.setOnClickListener {
            ...
            try {
                ...
                fun accountafterinterest() = firstNumber * (1 + secondNumber / 36500) .pow(365*thirdNumber)
                var COMPOUNDINTEREST=accountafterinterest()


                MYRESULT.text="The total amount accrued on a principal of $firstNumber at a rate of $secondNumber% per year compounded 365 times per year over $thirdNumber years  is $COMPOUNDINTEREST."

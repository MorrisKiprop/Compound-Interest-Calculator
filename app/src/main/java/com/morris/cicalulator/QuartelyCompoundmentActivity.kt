...
class QuartelyCompoundmentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_quartely_compoundment)
        ...
        CALCULATEBUTTON.setOnClickListener {
            ...
            try {
                ...
                fun accountafterinterest() = firstNumber * (1 + secondNumber / 400) .pow(4*thirdNumber)
                var COMPOUNDINTEREST=accountafterinterest()


                MYRESULT.text="The total amount accrued on a principal of $firstNumber at a rate of $secondNumber% per year compounded 4 times per year over $thirdNumber years is is $COMPOUNDINTEREST."

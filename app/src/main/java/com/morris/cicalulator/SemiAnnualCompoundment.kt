...
class SemiAnnualCompoundment : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_semi_annual_compoundment)
        ...
        CALCULATEBUTTON.setOnClickListener {
            ...
            try {
                ...
                fun accountafterinterest() = firstNumber * (1 + secondNumber / 200) .pow(2*thirdNumber)
                var COMPOUNDINTEREST=accountafterinterest()


                MYRESULT.text="The total amount accrued on a principal of $firstNumber at a rate of $secondNumber% per year compounded 2 times per year over $thirdNumber years  is $COMPOUNDINTEREST."

...
class SemiMonthlyActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_semi_monthly)
        ...
        CALCULATEBUTTON.setOnClickListener {
            ...
            try {
                ...
                fun accountafterinterest() = firstNumber * (1 + secondNumber / 2400) .pow(24*thirdNumber)
                var COMPOUNDINTEREST=accountafterinterest()


                MYRESULT.text="The total amount accrued on a principal of $firstNumber at a rate of $secondNumber% per year compounded 24 times per year over $thirdNumber years  is $COMPOUNDINTEREST."
